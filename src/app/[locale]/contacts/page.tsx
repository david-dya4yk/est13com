        ...
        <div className={`wrap ${s.grid}`}>
          ...
          <div>
            <div className={s.card}>
              ...
              <a className={s.chan} href={`mailto:${CONTACT.email}`}>
                ...
                <span>
                  ...
                  <span className={s.v}>{CONTACT.email}</span>
                </span>
              ...
              >
                ...
                <span>
                  ...
                  <span className={s.v}>{CONTACT.telegramHandle}</span>
                </span>
                <span className={s.arrow}>
                  <ArrowOut />
                </span>
              ...
              >
                ...
                <span>
                  ...
                  <span className={s.v}>{CONTACT.socialHandle}</span>
                </span>
                <span className={s.arrow}>
                  <ArrowOut />
                </span>
              ...
              >
                ...
                <span>
                  <span className={s.k}>Threads</span>
                  <span className={s.v}>{CONTACT.socialHandle}</span>
                </span>
                <span className={s.arrow}>
                  <ArrowOut />
